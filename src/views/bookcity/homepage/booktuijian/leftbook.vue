<template>
  <div id="app">
      <div class="main">
          <div class="head">
              <h3><img src="static/images/bookcity/title3.png"></h3>
              <ul>
            ...
            <div >
              <ul>
                <li v-for="data in arr">
                  <router-link :to='"/pageshow/bookcity/booksdetails/"+data.id'>
                    <img class="img1" :src="data.thumbnails" alt="" />
                    <p class="name">{{data.book_name}}</p>
                    <span class="cent"><img src="static/images/bookcity/book.png"/>当当独家特供</span>
